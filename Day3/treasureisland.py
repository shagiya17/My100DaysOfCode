...
choice1 = input("You come across a crossroad. Where would you like to go?"
                " Type 'left' or 'right'.\n").lower()
if choice1 == "left":
    ...
    if choice2 == 'wait':
        choice3 = input("You\'ve arrived at the island unharmed."
                        "There is 3 different colored doors."
                        "Blue, red, or yellow."
        ...
        print("You\'ve got attack by an angry trout. Game Over.")
else:
